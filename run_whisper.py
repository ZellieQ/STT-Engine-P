"""
Script to run the Whisper model on an audio file
"""
...
def transcribe_audio(file_path, language=None, model_size="tiny"):
    """
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python run_whisper.py <audio_file> [language] [model_size]")
        print("Example: python run_whisper.py sample.mp3 en tiny")
        return
